...
async function connectToWA() {
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❄️Frozen_Queen❄️ installed successful ✅");
      console.log("❄️Frozen_Queen❄️ connected to WhatsApp ✅");

      const up = `❄️Frozen_Queen❄️ connected successful ✅`;
      const up1 = `Hello ❄️Frozen_Queen_Owner❄️, I made bot successful`;
      ...
      robin.sendMessage("94701525284@s.whatsapp.net", {
        image: {
          url: `https://github.com/chathurahansaka1/help/blob/main/src/f52f8647-b0fd-4f66-9cfa-00087fc06f9b.jpg?raw=true`,
        },
        caption: up1,
  ...
  robin.ev.on("messages.upsert", async (mek) => {
    ...
    // Owner react
    if (senderNumber.includes("94701525284")) {
      if (isReact) return;
      m.react("☃️");
    }
...
// Express server
app.get("/", (req, res) => {
  res.send("Hey, ❄️Frozen_Queen❄️ started ✅");
});
